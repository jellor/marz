...
public:
	...
	static void Uint16ToStr(char *buf, uint16_t data) {
		buf[0] = static_cast<char>(data >> 8);
		buf[1] = static_cast<char>(data & 0xFF);
	}

	static void Uint32ToStr(char *buf, uint32_t data) {
	...
	static void Int16ToStr(char *buf, int16_t data) {
		buf[0] = static_cast<char>(data >> 8);
		buf[1] = static_cast<char>(data & 0xFF);
	}

	static void Int32ToStr(char *buf, int32_t data) {
		buf[0] = static_cast<char>(data >> 24);
		buf[1] = static_cast<char>((data >> 16) & 0xFF);
		buf[2] = static_cast<char>((data >> 8) & 0xFF);
		buf[3] = static_cast<char>(data & 0xFF);
	...
	static uint16_t StrToUint16(char *buf) {
		uint16_t data = (buf[0] << 8) | buf[1];
		return data;
	}

	static uint32_t StrToUint32(char *buf) {
		uint32_t data = (buf[0] << 24) | (buf[1] << 16) | (buf[2] << 8) | buf[3];
		return data;
	}

	static int16_t StrToInt16(char *buf) {
		int16_t data = (buf[0] << 8) | buf[1];
		return data;
	}

	static int32_t StrToInt32(char *buf) {
