...
class UserSvr : public Svr {
public:
	UserSvr() {
		DLOG << "UserSvr Svr Constructor ......";
	}
	~UserSvr() {
		DLOG << "UserSvr Svr Destructor ......";
	}
...
int main(int argc, char* argv[]) {
	...
	if (client_listen_hosts == NULL || client_listen_port == NULL) {
		WLOG << "Error : user_svr.conf Failed";
